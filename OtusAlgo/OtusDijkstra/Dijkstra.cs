...
namespace OtusDijkstra
{
    ...
    public class Dijkstra
    {
        ...
        public List<Edge> FindShortestPath(string startName, string finishName)
        {
        ...
        /// <returns>Кратчайший путь</returns>
        public List<Edge> FindShortestPath(GraphVertex startVertex, GraphVertex finishVertex)
        {
            InitInfo();
        ...
        List<Edge> GetPath(GraphVertex startVertex, GraphVertex endVertex)
        {
            List<Edge> vertices = new List<Edge>();
            while (startVertex != endVertex)
            {
                Edge edge = new Edge();
                edge.Dest = endVertex.ToString();
                endVertex = GetVertexInfo(endVertex).PreviousVertex;
                edge.Src = endVertex.ToString();
                vertices.Add(edge);
            }
